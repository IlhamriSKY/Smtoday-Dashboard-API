...
class BannedIklantexts extends Widget
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return view('plugins.dashboard.widgets.Smtoday.Iklantext.banned-iklantexts', [
            'count' => $this->iklantexts->countByStatus(IklantextStatus::BANNED)
        ]);
    }
}
