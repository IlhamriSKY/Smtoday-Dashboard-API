...
class UnSendIklantexts extends Widget
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return view('plugins.dashboard.widgets.Smtoday.Iklantext.unsend-iklantexts', [
            'count' => $this->iklantexts->countByStatus(IklantextStatus::UNSEND)
        ]);
    }
}
